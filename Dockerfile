...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-snippet-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-snippet-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-snippet-api/bin/ocp-snippet-api .
RUN chown root:root ocp-snippet-api
EXPOSE 82
CMD ["./ocp-snippet-api"]
